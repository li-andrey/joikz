...
if (!@$erorr) {
    ...
    $sql = "INSERT INTO i_" . $ob->pr($_GET['module']) . " (id_section,version," . $field_name . ") ";
    $sql.= "VALUES ('" . @$_GET['id_section'] . "','" . $ver . "'" . @$field . ")";
    ...
    if (!$i) {
        ...
        $mysql->query("update i_$nameElement set  slug='$id' where id='" . $id . "'");
