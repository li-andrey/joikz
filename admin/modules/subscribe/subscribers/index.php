                    ...
                    <div class="panel">
                      <div class="panel-heading">
                        ...
                        <div class="widget-menu pull-right">
                            <a href="option.php?module=<?=$nameRazdel?>&amp;id_section=<?=@$_GET['id_section']?>" target="_blank" class="btn btn-system  btn-sm">
...
if (@$_GET['excel'] == "true") {
    ...
    $select = $mysql->query("select * from i_$nameRazdel where (version='all' OR version='" . $_SESSION['version'] . "') " . $where . " ORDER BY " . $_SESSION["order"] . ",'puttime' DESC ");
