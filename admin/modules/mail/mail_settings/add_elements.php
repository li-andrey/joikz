...
if (@$_POST['hidden']) {
    ...
    if (@$_POST['hidden'] == 'save') {
        $page = "index.php?id_section=" . @$_GET['id_section'] . "&module=" . @$_GET['module']."&sub_module=" . @$_GET['sub_module'];
    } else { 
        $page = "";
    }
...
if (!@$erorr) {
    ...
    $sql = "INSERT INTO i_" . $ob->pr($_GET['module']) . " (id_section,version,url," . $field_name . ") ";
    $sql.= "VALUES ('" . @$_GET['id_section'] . "','" . $ver . "','" . @$translit . "'" . @$field . ")";
