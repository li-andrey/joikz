...
$sql = "select * from i_$nameElement where (version='all' OR version='" . $_SESSION['version'] . "') ";
...
$select_all = $mysql->query("select * from  i_$nameElement where (version='all' OR version='" . $_SESSION['version'] . "') " . $where . "");
?>
...
if (@$_GET['excel'] == "true") {
  ...
  $select = $mysql->query("select * from i_$nameElement where (version='all' OR version='" . $_SESSION['version'] . "') " . $where . " ORDER BY " . $_SESSION[$nameElement]["order"] . ",'puttime' DESC ");
