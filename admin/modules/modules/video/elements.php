            ...
            <div class="panel">
              <div class="panel-heading">
                ...
                <div class="widget-menu pull-right">
                  <a href="option.php?module=<?=$nameElement?>&amp;id_section=<?=@$_GET['id_section']?>" target="_blank" class="btn btn-system  btn-sm">
                 ...
                 <a href="import.php<?=$ob->gets_go($_GET, "", "")?>" target="_blank" class="btn btn-system btn-sm" style="margin-right: 20px;">
