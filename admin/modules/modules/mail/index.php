...
$sql = "select * from i_$nameRazdel where (version='all' OR version='" . $_SESSION[$nameRazdel]['version'] . "') ";
...
$select_all = $mysql->query("select * from  i_$nameRazdel where (version='all' OR version='" . $_SESSION[$nameRazdel]['version'] . "') " . $where . "");
?>
                    ...
                    <div class="panel">
                      <div class="panel-heading">
                        ...
                        <div class="widget-menu pull-right">
                            <a href="option.php?module=<?=$nameRazdel?>&amp;id_section=<?=@$_GET['id_section']?>"  class="btn btn-system  btn-sm">
                           ...
                           <a href="importc.php<?=$ob->gets_go($_GET, "", "")?>" target="_blank" class="btn btn-system btn-sm" style="margin-right: 20px;">
                ...
                <div class="panel-body">
                    ...
                    <table width="100%" class="table table-responsive table-hover table-bordered" style="color: #000; ">
                        ...
                        while ($res = $select->fetch_array()) {
                            ...
                            $section = $mysql->query("select * from i_$nameRazdel where (version='all' OR version='" . $_SESSION[$nameRazdel]['version'] . "')

                              AND id_section='" . $res['id'] . "'");

                            $elements = $ob->select("i_$nameElement", array("id_section" => $res['id'], "version" => $_SESSION[$nameRazdel]['version']), "");
...
if (@$_GET['excel'] == "true") {
    ...
    $select = $mysql->query("select * from i_$nameRazdel where (version='all' OR version='" . $_SESSION[$nameRazdel]['version'] . "') " . $where . " ORDER BY " . $_SESSION[$nameRazdel]["order"] . ",'puttime' DESC ");
    ...
    while ($res = $select->fetch_array()) {
        ...
        $section  = $mysql->query("select * from i_$nameRazdel where (version='all' OR version='" . $_SESSION[$nameRazdel]['version'] . "') AND id_section='" . $res['id'] . "'");
