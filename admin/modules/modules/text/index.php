      ...
      //-->
                  ...
                  foreach ($field as $k => $v) {
                    ...
                    if ($k == 'url') {
                      ...
                      echo '<td class="table_value"><a href="/' .($_SESSION[$nameRazdel]["version"]!='ru'?$_SESSION[$nameRazdel]["version"].'/':'')  . '' . $res['url'] . '/">/' .($_SESSION[$nameRazdel]["version"]!='ru'?$_SESSION[$nameRazdel]["version"].'/':'')  . '' . $res['url'] . '/</a>&nbsp;</td>';
...
if (@$_GET['excel'] == "true") {
  ...
  $select = $mysql->query("select * from i_$nameElement where (version='all' OR version='" . $_SESSION['version'] . "') " . $where . " ORDER BY " . $_SESSION[$nameRazdel]["order"] . ",'puttime' DESC ");
 ...
 $field1 = $field;
    ...
    while ($res = $select->fetch_array()) {
        ...
        foreach ($field1 as $k => $v) {
            if ($k == 'url') {
                $str .= '<td class="table_value"><a href="/' .($_SESSION[$nameRazdel]["version"]!='ru'?$_SESSION[$nameRazdel]["version"].'/':'')  . '' . $res['url'] . '/">/' .($_SESSION[$nameRazdel]["version"]!='ru'?$_SESSION[$nameRazdel]["version"].'/':'')  . '' . $res['url'] . '/</a>&nbsp;</td>';
            }
        }
