...
class Faq extends Module{
	public $table = 'i_quest';
	public $tableE = 'i_quest';
	...
	public function listElements($ids)
	{
			...
			$data = array(
				'meta' => array('title'=> $block["title"]!=''?$block["title"]:$block["name"], 'h1'=> $block["title"]!=''?$block["title"]:$block["name"], 'descr' => $block["descr"], 'keyw' => $block["keyw"]),
				'block' => $block,
				'subBlock' => $subBlock,
				'elements' => $elements,
